...
namespace WebApplicationNetCoreDev.Controllers
{
    public class AdvertisingCampaignController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,PricePerClick,NumberOfClicks,TotalCost,Created")] AdvertisingCampaign advertisingCampaign)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,PricePerClick,NumberOfClicks,TotalCost,Created")] AdvertisingCampaign advertisingCampaign)
        {
